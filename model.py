...
def retrieval_qa_chain(llm, prompt, db):
    # To make the model answer based on the knowledge source (db), we need to return_source_documents=True, otherwise it will answer based on Llama2's knowledge instead
